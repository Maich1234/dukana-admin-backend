...
/** POST /admin/settings/platform-config/verification/request */
export const requestVerification = async (req, res) => {
  try {
    ...
    console.error('[PlatformConfigVerification] requestVerification error:', err);
...
/** POST /admin/settings/platform-config/verification/verify */
export const verifyCode = async (req, res) => {
  try {
    ...
    return res.json({ success: true, data: { verificationToken }, message: 'Verified successfully.' });
  } catch (err) {
    console.error('[PlatformConfigVerification] verifyCode error:', err);
