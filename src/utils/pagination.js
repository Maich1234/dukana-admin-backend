 ...
 * page.
 *
 * `countDocuments` on a high-volume collection is the slowest part of a list
 * request and it was being paid on every scroll. Instead we over-fetch by one
 * document to learn whether another page exists, and only pay for an exact
 * count on page 1 — which is the only page whose `total` any client displays.
 *
