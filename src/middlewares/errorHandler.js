const DUPLICATE_KEY_MESSAGES = {
  ...
  tokenHash: 'This session token has already been issued.',
  shopId: 'This shop is already linked to another onboarding record.',
  'sourceTransactionType + sourceTransactionId': 'A commission record already exists for this transaction.',
  key: 'This configuration record already exists.',
